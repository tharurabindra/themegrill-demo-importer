			...
			<div class="theme-info">
				...
				<form method="post" id="bulk-action-form">
					<table class="plugins-list-table widefat">
						...
						<tfoot>
							<tr>
								<th class="plugin-installer" colspan="4">
									<a href="#" class="button button-primary plugin-install"><?php _e( 'Install plugins', 'themegrill-demo-importer' ); ?></a>
									<a href="#" class="button button-secondary plugin-activator"><?php _e( 'Activate plugins', 'themegrill-demo-importer' ); ?></a>
								</th>
							</tr>
						</tfoot>
					</table>
